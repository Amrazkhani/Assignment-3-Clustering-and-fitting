...
def balance_data(df):
  ...
  min_length = min(len(nitrous_oxide), len(nitrous_oxide), len(nitrous_oxide))
...
scaler = MinMaxScaler()
scaled_data = scaler.fit_transform(df[['nitrous_oxide', 'agricultural_land',
...
plot_clusters('nitrous_oxide', 'agricultural_land')

plot_clusters('greenhouse_gas_emissions', 'agricultural_land')
...
plot_country_cluster('Aruba', 'nitrous_oxide', 'agricultural_land')

plot_country_cluster('Singapore', 'greenhouse_gas_emissions', 'agricultural_land')
